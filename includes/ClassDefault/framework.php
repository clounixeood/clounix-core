...
/////////////// Radiogroup
    ...
    function FormOpen($action = '', $method = 'post', $name = '', $attribute = array())
    {
        ...
        $content = "\t<!-- FormStart -->\n<form"
                    .' role="form" action="'.$action.'" method="'.$method.'" name="'.$name.'" id="'.$name.$randform.'"';
        ...
        if($attribute['noattr_validation'] == '1'){ $content .= "\t".'<script>$(document).ready(function() { $(\'#'.$name.$randform.'\').bootstrapValidator(); });</script>'."\n"; }
