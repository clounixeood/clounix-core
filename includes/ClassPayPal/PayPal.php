...
class phpPayPal { 
	...
	*/
	...
	public $currency_code = "EUR"; // CURRENCYCODE
	...
	*/
	...
	public $RequestFieldsArray = array(
		...
		'SetExpressCheckout' => array(
				...
				'landing' 				    => array('name' => 'LANDING', 'required' => 'no'),
	...
	public function set_express_checkout_successful_redirect_commit()
	{
		// Redirect to paypal.com here
		$token = urlencode($this->Response["TOKEN"]);
		$paypal_url = $this->PAYPAL_URL.$token.'&useraction=commit';
		header("Location: ".$paypal_url);
	}
