...
class paypal
{
	...
	function output_form()
	{
		...
		. '<html xmlns="http://www.w3.org/1999/xhtml"><head><title>Ti stiamo collegando a PayPal...</title></head>'
		.'<body onload="document.f.submit();"><h3>Ti stiamo collegando a PayPal...</h3>'
		...
		echo '<input type="submit" value="Clicca qui se non vieni collegato a PayPal entro 10 secondi" /></form></body></html>';
